...
Class User_model extends Model {
	 ...
	 * @return object
	 */
	function updateUserInfo($email, $name, $password, $group_id, $profile_image, $user_id) {
		$sql1 = '
					UPDATE
						user
					SET
					...
					WHERE
						id = ?
				';					
		$this->query_exec($sql1, array($email, $name, $password, $group_id, $profile_image, $user_id));
		$sql2 = '
					SELECT
						*
					FROM
					...
					WHERE
						email = ?
				';
		return $this->query_row($sql2, array($email));
	}
