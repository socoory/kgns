<?php
	...
	/**
	 * feed header include header image
	 * 
	 * @author Benimario
	 * @since 2015.02
	 */
            ...
            <div class="row">
			    ...
			    <div class="col-md-10 text-right">
					...
					<div style="display: inline-block; padding-right: 10px; position: relative;">
						<a href="<?=URL?>/timeline/write"><img src="<?=URL?>/images/notice.png" style="height: 22px;"></a>
						<div id="circle" style="position: absolute; top: -3px; right: 3px; line-height: 11px; text-align: center; font-size: 10px;">
						<?sNotify.queue.length?></div>
					</div>
