<div class="basebox pd_lr_10 pd_tb_5">
	<div class="col-md-6 center_block pd_10">							
		<form id="edit_form" action="<?=URL?>/gns_admin/edit_group_process" method="post" class="form-horizontal">
			...
			<div  class="form-group">
				...
				<div class="col-sm-8"><input type="text" name="group_name" class="form-control" value=<?php echo($group->group_name) ?>></div>
			</div>			
